      ...
      <div className="relative z-10 min-h-screen">
        <section className="py-12 md:py-40 px-4 md:px-10">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter mb-8">AI & Automation</h1>
            <p className="text-white/70 text-lg max-w-2xl">
              Deployable machine learning pipelines, feature stores, and end-to-end automation that reduces 
            ...
            <div className="bg-black/80 backdrop-blur-xl border-l border-white/20 rounded-r-2xl p-8 md:p-12">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <strong className="text-white block mb-1">ML Pipelines</strong>
                    <span className="text-white/60">Reproducible training and deployment</span>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <span className="w-2 h-2 rounded-full mt-2" style={{ backgroundColor: themeColor }}></span>
                  <div>
                    <strong className="text-white block mb-1">Feature Stores</strong>
                    <span className="text-white/60">Centralized feature management</span>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <span className="w-2 h-2 rounded-full mt-2" style={{ backgroundColor: themeColor }}></span>
                  <div>
                    <strong className="text-white block mb-1">Drift Detection</strong>
                    <span className="text-white/60">Automated model monitoring</span>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <span className="w-2 h-2 rounded-full mt-2" style={{ backgroundColor: themeColor }}></span>
                  <div>
                    <strong className="text-white block mb-1">Explainable AI</strong>
                    <span className="text-white/60">Transparency in model decisions</span>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-black/80 backdrop-blur-xl border-l border-white/20 rounded-r-2xl p-8 md:p-12">
              ...
              <p className="text-white/70">
                Focused on operationalising ML, our solutions emphasise explainability, cost-efficient 
                inference, and integration with existing data platforms while ensuring access control 
